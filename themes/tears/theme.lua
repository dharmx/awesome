...
theme.wibar_battery_bg = colors.bblack:lighten(12):to_hex(true)
theme.wibar_battery_safe = colors.bgreen:to_hex(true)
theme.wibar_battery_eighty = colors.bgreen:to_hex(true)
theme.wibar_battery_sixty = colors.blue:to_hex(true)
theme.wibar_battery_fourty = colors.bblue:to_hex(true)
theme.wibar_battery_thirty = colors.yellow:to_hex(true)
theme.wibar_battery_twenty = colors.byellow:to_hex(true)
theme.wibar_battery_critical = colors.bred:to_hex(true)
